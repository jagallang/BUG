...
class _TesterDashboardPageState extends ConsumerState<TesterDashboardPage>
  ...
  void _performLogout(BuildContext context) async {
    ...
    try {
      ...
      // 1. Dashboard Provider 정리 (StreamSubscription 포함)
      ref.invalidate(testerDashboardProvider);
      debugPrint('🔴 testerDashboardProvider 정리 완료');

      // 2. Auth Provider 정리
      ref.invalidate(authProvider);
      debugPrint('🔴 authProvider 정리 완료');
      ...
      children: [
        ...
        Expanded(
          child: filteredMissions.isEmpty
              ...
              : ListView.builder(
                  padding: ResponsiveWrapper.getResponsivePadding(context).copyWith(
                    top: 16.h,
                    bottom: 16.h,
                  ),
